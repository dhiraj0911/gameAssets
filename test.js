        ...
        <div className="mt-16 ">
          ...
          <div className="mt-4 flex flex-col items-center">
            <input
              ...
              className="dark:bg-nft-black-1 bg-white border border-nft-gray-2 p-2 rounded-md mb-4 w-full dark:text-white text-nft-black-1 text-m"
              placeholder="Enter API Endpoint"
            />

            {/* <button
              onClick={handleFetchAssets}
              className="mt-3 bg-blue hover:bg-blue-400 text-white text-m rounded w-35 max-w-[10em] dark:bg-nft-black-1 dark:text-white font-semibold text-m py-3 hover:border"
            >
              Fetch Assets
            </button> */}
            <button
              onClick={handleFetchAssets} 
              className="bg-nft-black-2 hover:bg-blue-400 text-black font-bold py-3 px-6 rounded-full shadow-lg shadow-neutral-950 hover:text-white transform transition-all">
              Keep holding
            </button>
          </div>
